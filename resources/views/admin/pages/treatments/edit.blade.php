                ...
                <div class="card mt-2">
                    <div class="card-header">
                       <div class="row">
                        ...
                        <div class="col text-gray"><h5 style="margin-left:380px;">Update Treatement</h5></div>
                       </div>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <form method="POST" action="{{ route('update.treatment') }}">
                                ...
                                <div class="card mt-3">
                                    <div class="card-header bg-gray">
                                        <p class="text-white"><strong>Treatment {{$treatment->id}}</strong></p>
                                    </div>
                                    <div class="card-body">
                                        <div class="form-row">
                                            <div class="col">
                                                <label for="dateField">Points:</label>
                                                <input type="text" class="form-control" id="dateField" name="hijama_points" value="{{$treatment->points}}">
                                            </div>
                                            <div class="col">
                                                <label for="radioDropdown">Fee:</label>
                                                <input type="number" class="form-control" id="inputField2" name="hijama_fee" value="{{$treatment->fee}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col">
                                                ...
                                                <input type="date" class="form-control" id="dateField" name="hijama_date" value="{{$treatment->date}}">
                                            </div>
                                            <div class="col">
                                                <label for="radioDropdown">Points Qty</label>
                                                <input type="text" class="form-control" id="inputField2" name="points_qty" value="{{$treatment->point_qty}}">
                                            </div>
                                        </div>

                                        <div class="form-row">
                                            <label for="radioDropdown">Medicines</label>
                                            <textarea class="form-control" id="textareaField" name="medicines" rows="3" value="">{{$treatment->medicine}}</textarea>
                                        </div>
                                    </div>
