                ...
                <div class="card mt-2">
                    <div class="card-header">
                       <div class="row">
                        ...
                        <div class="col text-gray"><h5 style="margin-left:380px;">Update Medicine</h5></div>
                       </div>
                    </div>
                    <!-- /.card-header -->
                                    ...
                                    <div class="card-body">
                                        <div class="form-row">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" id="dateField" name="name" value="{{$medicine->name}}">
                                            </div>
                                            <div class="col">
                                            <label for="radioDropdown">Purchase Price:</label>
                                                    <input class="form-control" id="medi_price" type="text" name="purchase_price" value="{{$medicine->purchase_price}}"
                                                        placeholder="Enter Medicine Purchase Price"  required/>
                                                <!-- <label for="radioDropdown">Cause:</label>
                                                <input type="text" class="form-control" id="inputField2" name="cause" value="{{$medicine->cause}}"> -->
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="form-row">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" id="dateField" name="description" value="{{$medicine->description}}">
                                            </div>
                                            <div class="col">
                                                <label for="radioDropdown">Diagnostic:</label>
                                                <input type="text" class="form-control" id="inputField2" name="diagnostic" value="{{$medicine->diagnostic}}"
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col">
