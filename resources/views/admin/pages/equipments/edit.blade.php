            ...
            <div class="col-md-12">
                <div class="card mt-5 custom-card">
                    <div class="card-header bg-gray">
                       <div class="row">
                        <div class="col text-white"><h5 style="margin-left:460px;">Edit Equipment</h5></div>
                       </div>
                    </div>

                    <div class="card-body">
                        <div class="container text-gray">
                            <form id="myForm_id" method="POST" action="{{ route('update.equipment')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" class="form-control" id="total_qty" name="equip_qty" min="0" value="0" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <select class="form-control" id="gender_id" name="equpment_type" required>
                                            <option name="option" selected>{{$equipment->type}}</option>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <button type="submit" class="btn btn-secondary form-control" id="submitform">Update</button>
                                    </div>
                                </div>
                            </form>
