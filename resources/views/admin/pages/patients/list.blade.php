            ...
            <div class="col-md-12">
                <div class="card mt-3">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <a href="{{route('patient.view')}}" class="btn btn-primary btn-sm"><i class="fas fa-plus-circle mr-2"></i>Add Patient</a>
                            </div>
                            <div class="col"></div>
                            <div class="col"></div>
                            <div class="col"></div>
                            <div class="col text-gray"><strong>Total Cups = {{$total_cups}}</strong></div>
                        </div>
                    </div>
                    <!-- /.card-header -->
