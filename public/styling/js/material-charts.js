...
MaterialCharts.pie = function (element, data) {
    ...
    MaterialCharts.helpers.insertTitle(element, data.title);
    var pieChartPercentages = MaterialCharts.helpers.pie.computePercentages(data.datasets);
    var pieChartAngles = MaterialCharts.helpers.pie.computeAngles(pieChartPercentages);
    MaterialCharts.helpers.pie.drawPieSections(element, data.datasets.labels, pieChartPercentages, pieChartAngles);
